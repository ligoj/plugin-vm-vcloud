...
export default defineConfig({
  ...
  build: {
    ...
    outDir: resolve(__dirname, '../src/main/resources/META-INF/resources/webjars/vm-vcloud/vue'),
    emptyOutDir: true,
    rollupOptions: {
  ...
  server: { port: 5195, proxy: { '/rest': { target: 'http://localhost:8080', changeOrigin: true }, '/webjars': { target: 'http://localhost:8080', changeOrigin: true } } },
